                    ...
                    <tbody>
                        ...
                        @foreach ($blogs as $blog)
                            <tr>
                                ...
                                <td>{{ $blog->type }}</td>
                                <td>{{ $blog->room_number }}</td>
                                <td>{{ $blog->price }}</td>
                                <td>
                                    <a href="{{ route('editview', $blog->id) }}" type="button"
                                        class="btn btn-warning">แก้ไข</a></th>
                                    <a href="{{ route('delete', $blog->id) }}" class="btn btn-danger"
                                        onclick="return confirm('คุณต้องการลบห้องพักนี้ {{ $blog->room_number }} หรือไม่')">ลบ</a>
                                </td>
                            </tr>
                        @endforeach
