                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ url('/admin/layout-static') }}">จัดการห้องพัก</a>
                            </nav>
                        </div>
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div style="margin: 20px">
                    ...
                    <img src="{{ asset('storage/img/'.basename($room->img)) }}" alt="Room Image" style= "width: 20rem;" class="rounded mx-auto d-block" >
                    ...
                    <form method="POST" action="{{route('update',$room->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="formFile" value="{{ $room->img }}"
                                name="formFile">
                        </div>
                        
                        <div class="mb-3">
                            <label for="cars">ประเภทห้องพัก : </label>
                            <select id="type" name="type" value="{{ $room->type }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="support" placeholder="รองรับ"
                                value="{{ $room->support }}" name="support">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="space"
                                placeholder="กรองขนาดของห้องพัก" value="{{ $room->space }}" name="space">
                        </div>
                        ...
                        <div class=>
                            <button href="/admin/layout-static" type="submit" class="btn btn-primary" data-bs-dismiss="modal">อัปเดต</button>
                    </form>
                </div>
