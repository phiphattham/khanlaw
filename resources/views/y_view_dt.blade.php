...
<body style="background-color: #F2F2F2">
                    ...
                    <div class="card-body ms-5 mt-4">
                        ...
                        <div class="card" style="width: 30rem;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><svg class="me-3" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    </svg>Check-in <input type="date"></li>
                                ...
                                <li class="list-group-item"><svg class="me-3" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path
                                            d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5z" />
                                    </svg>Check-out <input type="date"></li>
                            ...
                            <div class="card-footer">
                                <li class="list-group-item"><svg class="me-3" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    </svg>ราคา 500 บาท/คืน <button class="btn btn-primary" type="button"
    ...
    <div class="card my-5 mx-5">
        <div class="row">
            <div class="col">
                <img src="{{ asset('img/p4.jpg') }}" class="img-fluid rounded-start">
            </div>
            <div class="col">
                <div class="card-body">
                    ...
                    <div class="card" style="width: 50rem;">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item my-2"><svg class="me-3" xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg>ห้องพักที่ 101 เต้นกระโจม</li>
