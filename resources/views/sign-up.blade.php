...
<body style="background-color: #F2F2F2">
    ...
    <div class="container mt-5">
        <main class="w-100 m-auto">
            <form>
                <ins class="h3 mb-3 fw-narmal">Sign-up</ins>
                <!--ส่วนของชื่อ-->
                ...
                <div class="form-floating">
                    ...
                    <label for="name">กรอกนามสกุลของคุณ</label>
                </div>
                <!--ส่วนของ tel-->
                <div class="form-floating">
                    <input type="text" class="form-control" id="number" placeholder="number">
                    <label for="name">กรอกเบอร์โทรศัพท์ของคุณ</label>
                </div>
                <!--ส่วนของนาม sex-->
                <div class="form-floating">
                    <p class="mx-2">เพศ : 
                ...
                <!--ส่วนของ username-->
                <div class="form-floating">
                    <input type="text" class="form-control" id="username" placeholder="usernaem">
                    <label for="name">กรอกชื่อผู้ใช้ของคุณ</label>
                </div>
                <!--ส่วนของ password-->
                <div class="form-floating">
                    <input type="paassword" class="form-control" id="password" placeholder="password">
                    <label for="password">กรอกรหัสผ่าน</label>
                </div>
                <!--ส่วนของ Comfirm password-->
                <div class="form-floating">
                    <input type="paassword" class="form-control" id="confirmpassword" placeholder="confirmpassword">
